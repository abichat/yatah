...
test_that("options are correct", {
  ...
  expect_equal(taxtree(taxtable, collapse = FALSE)$edge.length, rep(1/3, 9))
})

taxtable2 <- taxtable
taxtable2$order <- NA
taxtable2[5:6, ] <- taxtable2[1:2, ]
taxtable2[2, 3] <- NA
